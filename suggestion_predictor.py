...
def define_best_suggestion(p):
    ...
    if p == 2:
        ...
        return 'If the positive sentiment conveyed in your tweet is increased by 10%, it will do better. Try adding a few cheerful words'
    elif p == 14:
        return 'If the positive sentiment conveyed in your tweet is increased by 25%, it will do better. Try adding a few cheerful words'
    elif p == 15:
